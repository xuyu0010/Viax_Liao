...
#		print(h_top5_max.shape)
		...
		indices_h_cen = torch.zeros(5, 7, 2)
...
class MFNET_FIVEP_LINEAR35_FRAME(nn.Module):

	def __init__(self, num_classes, pretrained=False, **kwargs):
		super(MFNET_FIVEP_LINEAR35_FRAME, self).__init__()
...
if __name__ == "__main__":
	...
	# ---------
	net = MFNET_FIVEP_LINEAR35_FRAME(num_classes=100, pretrained=False)
