...
#		print(h_top5_max.shape)
		...
		indices_h_cen = torch.zeros(5, 3, 2)
...
class MFNET_FIVEP_LINEAR15_FRAME(nn.Module):
...
if __name__ == "__main__":
	...
	# ---------
	net = MFNET_FIVEP_LINEAR15_FRAME(num_classes=100, pretrained=False)
