...
parser.add_argument('--gpus', type=str, default="0,1,2,3,4,5,6,7",
					help="define gpu id")
# algorithm
parser.add_argument('--network', type=str, default='C2D_50_NL',
					choices=['MFNet_3D, MFNet_3D_NL, C2D_50, C2D_50_NL'],
...
parser.add_argument('--lr-steps', type=list, default=[int(1e5*x) for x in [12,24,36]],
